  ...
  <tbody>
    <?php $__empty_1 = true; $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <tr>
        ...
        <!-- رابط عرض الملف -->
       <td>
  <a href="<?php echo e(asset('storage/archived_documents/'.$doc->file_name)); ?>"
     target="_blank"
...
</html><?php /**PATH C:\Users\LENOVO\legal_system\resources\views/clerk_dashboard/archiver.blade.php ENDPATH**/ ?>